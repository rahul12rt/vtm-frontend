    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const response = await fetch(
          `${strapiApiUrl}/api/results?populate[create_test][populate][subject][populate]=class&populate[student][populate]=college&populate[create_test][populate]=academic_year&filters[create_test][id][$eq]=${id}`
        );
