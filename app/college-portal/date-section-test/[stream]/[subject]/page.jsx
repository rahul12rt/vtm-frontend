  ...
  useEffect(() => {
    const fetchResults = async () => {
      try {
        ...
        let resultsEndpoint = `${strapiApiUrl}/api/results?filters[create_test][exam_type][$eq]=1&filters[student][college][user_name][$eq]=${collegeUsername}&populate[create_test][populate][subject][populate]=class&populate[create_test][populate]=academic_year&filters[create_test][exam_name][$eq]=${stream.toUpperCase()}&populate=student&filters[create_test][subject][class][id][$eq]=${activeClass}`;
