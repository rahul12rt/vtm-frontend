...
export async function GET() {
  try {
    ...
    const strapiEndpoint = `${strapiApiUrl}/api/creat-dpps?populate[class]=*&populate[subject][populate][class]=*&populate[chapters]=*&populate[topics]=*&populate[academic_year]=*&populate[material]=*`;
...
export async function PUT(request) {
  try {
    ...
    const strapiEndpoint = `${strapiApiUrl}/api/creat-dpps/${studyId}?populate[class]=*&populate[subject][populate][class]=*&populate[chapters]=*&populate[topics]=*&populate[academic_year]=*&populate[material]=*`;
    const response = await fetch(strapiEndpoint, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
