...
export async function GET() {
  try {
    ...
    const strapiEndpoint = `${strapiApiUrl}/api/self-studies?populate[class]=*&populate[subject][populate][class]=*&populate[chapters]=*&populate[topics]=*&populate[academic_year]=*&populate[material]=*`;
...
export async function PUT(request) {
  try {
    ...
    const strapiEndpoint = `${strapiApiUrl}/api/self-studies/${studyId}?populate[class]=*&populate[subject][populate][class]=*&populate[chapters]=*&populate[topics]=*&populate[academic_year]=*`;
    const response = await fetch(strapiEndpoint, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
